...
INSERT INTO MemberOfEducationUnit(ID, Gender, Fname, Lname, DOB, Email)
VALUE ('000000009','F','Vo','Chau','1990-01-01','chauvtn@hcmut.edu.vn');
INSERT INTO MemberOfEducationUnit(ID, Gender, Fname, Lname, DOB, Email)
VALUE ('000000010','F','Nguyen','Thao','1990-09-20','nguyenaithao@gmail.com');
INSERT INTO MemberOfEducationUnit(ID, Gender, Fname, Lname, DOB, Email)
...
VALUE ('000005');
INSERT INTO Lecturer(LID, LSLID)
VALUE ('000002', '000005');
INSERT INTO Lecturer(LID, LSLID)
VALUE ('000003', '000005');
...
VALUES ('CO2014','He co so du lieu',True,3,'Khoa khoa hoc va ki thuat may tinh');
INSERT INTO Subject(CID, CName, Status, NoCredits, FCName)
VALUES ('CO3005','Nguyen ly ngon ngu lap trinh',True,3,'Khoa khoa hoc va ki thuat may tinh');
INSERT INTO Subject(CID, CName, Status, NoCredits, FCName)
VALUES ('CO2015','Cong nghe phan mem',True,3,'Khoa khoa hoc va ki thuat may tinh');
INSERT INTO Subject(CID, CName, Status, NoCredits, FCName)
VALUES ('CO2008','Kien truc may tinh',False,3,'Khoa khoa hoc va ki thuat may tinh');
INSERT INTO Subject(CID, CName, Status, NoCredits, FCName)
